...
describe('compareEmail', function() {
  it('should return a user with valid email', function() {
    ...
    // assert statement below - strictEqual for primitive. deepEqual for objects
...
describe('shortURLforUser', function() {
  ...
  it('should return false if user is empty', function() {
    const exists = shortURLforUser({}, "i3BoGr", "");
    const expectedOutput = false;
    // assert statement below - strictEqual for primitive. deepEqual for objects
    assert.strictEqual(exists, expectedOutput);
  });
